-- Подсветка через treesitter для любого языка, чей парсер установлен (список —
-- в plugins/treesitter.lua). pcall обязателен: без парсера start() бросает
-- ошибку и ломает открытие файла целиком, а не просто оставляет его без цветов.
